...
def segment_route(
    ...
    vehicle_config: optional dict:
                    {
                      ...
                      'first_delivery_coord_index': int
                    }
    ...
    for ref in references:
        ...
        matched_ref_objects.append({
            ...
            'type': ref.get('type', ''), 'name': ref.get('name', ''),
        })
        ...
        for seg_idx in range(seg_start, seg_end):
            for ref in ref_by_seg.get(seg_idx, []):
                ...
                if rtype == 'caseta':
                    ...
                    referencias.append(f"Rampa de emergencia: {rname} a {km_str}")
        ...
        if needed > 0:
            ...
            for j, cp in enumerate(checkpoints):
                ...
                matched_ref_objects.append({
                    ...
                    'type': 'seguimiento', 'name': cp_name,
                })

        # Emergency contacts from tramo midpoint
