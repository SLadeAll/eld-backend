"""
Django settings for assesBackend project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-w*_mil@vqkk#42tvw7^bjz2$x1q87_98v&)nkv#t47wyx8dqz@')
...
ROOT_URLCONF = 'assesBackend.urls'
...
WSGI_APPLICATION = 'assesBackend.wsgi.application'
